...
const AR: ContentBundle = {
  ...
  products: {
    cookie: {
      ...
      ingredients:
        "شوفان كامل الحبة، دقيق قمح كامل، زبدة غير مملّحة، شوكولاتة داكنة، حليب منزوع الدسم مُخمَّر، سكر جوز الهند، حبوب الفانيليا، مواد رافعة، ملح البحر.",
      ingredientChips: [
        "شوفان كامل الحبة",
        "شوكولاتة داكنة 80%",
        "سكر جوز الهند",
      ...
      nutrition: [
        { label: "الطاقة", value: "205 سعرة", highlight: true },
        ...
        { label: "الدهون المشبعة", value: "3.8 جم" },
    ...
    protein: {
      ...
      shelfLife: "15 يومًا من تاريخ الإنتاج",
      ingredients:
        "شوفان كامل الحبة، بروتين مصل اللبن المعزول، دقيق قمح كامل، زبدة غير مملّحة، حليب منزوع الدسم مُخمَّر، شوكولاتة داكنة، سكر جوز الهند، حبوب الفانيليا، مواد رافعة، ملح البحر.",
      ingredientChips: [
        "شوفان كامل الحبة",
      ...
      nutrition: [
        { label: "الطاقة", value: "200 سعرة", highlight: true },
